...
<?php $__env->startSection('title', 'Virgilio Handicraft | About Us'); ?>
    ...
    <div class="container pb-5 mt-5 mt-lg-6">
        <div class="row justify-content-center">
            <div class="col-md-6 text-center">
                <img class="img-fluid d-block mx-auto" src="<?php echo e(asset('img/about/about-us.svg')); ?>" alt="about-us">
...
<?php echo $__env->make('layouts.main.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Aes\Desktop\PERSONAL PROJECTS\---------PENDING PROJECTS----------\ON GOING\Virgilio Handcraft Ecommerce\project\resources\views\main\pages\about.blade.php ENDPATH**/ ?>