...
<link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700" rel="stylesheet"> {{-- Fonts --}}
...
<link href="{{ asset('assets/css/utils/nucleo/nucleo-svg.css') }}" rel="stylesheet" /> {{-- Nucleo --}}
